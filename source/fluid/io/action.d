...
interface ActionIOv1 : IO {
    ...
    deprecated("`ActonIOv1.emitEvent` has been superseded by `ActionIOv2.emitEvent`, "
        ~ "and will be removed in Fluid 0.8.0. Please use `ActionIOv2` instead.")
...
interface ActionIOv2 : ActionIOv1 {
