...
void assertClean(ref Children children, lazy string message) pure {
...
/// Make sure the given children list hasn't changed since the dirty bit was last cleared.
void assertClean(ref Children children) pure {
...
void clearDirty(ref Children children) pure {
...
pragma(inline)
void lock(ref Children children) pure {
...
pragma(inline)
void unlock(ref Children children) pure {
...
pragma(inline)
void assertLocked(ref Children children) pure {
...
pragma(inline)
const(Node[]) asConst(Children children) pure {
...
pragma(inline)
ref Node[] forceMutable(return ref Children children) @system pure {
